...
import PvheeCheckersPvheeCheckersCheckers from './pvhee/checkers/pvhee.checkers.checkers'
...
export default { 
  ...
  PvheeCheckersPvheeCheckersCheckers: load(PvheeCheckersPvheeCheckersCheckers, 'pvhee.checkers.checkers'),
